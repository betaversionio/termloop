  ...
  return (
    ...
    >
      <input
        ...
        placeholder="Search"
        className="mt-20 w-[280px] rounded-[10px] bg-white/10 border border-white/15 px-4 py-2 text-sm text-white placeholder:text-white/50 outline-none focus:bg-white/15 transition-colors"
      />
      ...
      >
        ...
        {apps.length === 0 && (
          <p className="col-span-full text-center text-sm text-white/50 mt-8">No apps found</p>
        )}
      </div>
    </div>
  );
