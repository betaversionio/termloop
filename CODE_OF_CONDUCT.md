...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported via GitHub's private reporting for this repo (**Security** tab → **Report a vulnerability**, which reaches maintainers privately regardless of the report's actual category) or by opening a GitHub issue if the concern doesn't need to stay private. All complaints will be reviewed and investigated promptly and fairly.
